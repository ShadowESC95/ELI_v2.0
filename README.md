...
own smart-home server — all behind a single typed or spoken interface with **216 capabilities**.
...
<details>
<summary><b>Full capability breadth — 216 capabilities across 17 areas</b></summary>
...
*Last updated 2026-08-17 (v2.2.5).*
...
- `tests` — a large pytest suite (9,291+ tests across 308+ files, including a `claims/` layer that
