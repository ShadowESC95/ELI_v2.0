...
> **v2.4.32 — check-in is not a maintenance dump.** "just checking in … what have you been doing?" stayed CHAT (not packaged SELF_REPORT); phatic no longer forces quick on that ask.
>
