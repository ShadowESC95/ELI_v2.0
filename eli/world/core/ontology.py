...
OBJECT_TEMPLATES: Dict[str, Dict[str, Any]] = {
    ...
    "cot_scratchpad": {"name": "Private Scratchpad", "object_type": "reasoning_artifact", "symbolic_meaning": "Normal mode — ELI is privately reasoning through the problem step by step.", "default_room": RoomType.REFLECTION_CHAMBER.value, "importance": 0.8, "affordances": ["inspect", "reflect", "synthesize"]},
    "cot_synthesis": {"name": "Synthesis Draft", "object_type": "reasoning_artifact", "symbolic_meaning": "Normal mode — condensing the private reasoning into the final answer.", "default_room": RoomType.REFLECTION_CHAMBER.value, "importance": 0.75, "affordances": ["inspect", "finalize"]},
    "tot_branch_tree": {"name": "Branch Tree", "object_type": "reasoning_artifact", "symbolic_meaning": "Research mode — ELI is proposing and scoring candidate approaches.", "default_room": RoomType.SIMULATION_LAB.value, "importance": 0.85, "affordances": ["simulate", "visualize", "select_branch"]},
    "tot_development": {"name": "Development Console", "object_type": "reasoning_artifact", "symbolic_meaning": "Research mode — developing the highest-scoring branch into the final answer.", "default_room": RoomType.SIMULATION_LAB.value, "importance": 0.8, "affordances": ["build", "develop", "finalize"]},
    "cai_draft": {"name": "Draft Manuscript", "object_type": "reasoning_artifact", "symbolic_meaning": "Expert mode — initial draft generated, awaiting principle critique.", "default_room": RoomType.EVIDENCE_WALL.value, "importance": 0.8, "affordances": ["inspect", "review"]},
    "cai_critique_panel": {"name": "Principle Critique Panel", "object_type": "reasoning_artifact", "symbolic_meaning": "Expert mode — critiquing the draft against P1-P5 principles; failures will be revised.", "default_room": RoomType.ANOMALY_ROOM.value, "importance": 0.9, "affordances": ["contain_anomaly", "flag_uncertainty", "inspect_claim"]},
    "sc_sample_cluster": {"name": "Sample Cluster", "object_type": "reasoning_artifact", "symbolic_meaning": "Advanced mode — generating independent answer samples for consensus selection.", "default_room": RoomType.EVIDENCE_WALL.value, "importance": 0.85, "affordances": ["link_evidence", "compare", "audit"]},
}
