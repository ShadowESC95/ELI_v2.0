...
def crisis_steering_directive(signal: str = "") -> str:
    ...
    return (
        ...
        "  • Encourage contacting a human who can help right now. Share region-appropriate "
        "crisis resources when known (examples: US/Canada 988 Suicide & Crisis Lifeline, "
        "UK/Ireland Samaritans 116 123, EU emergency 112, or findahelpline.com for local "
        "numbers). If the user's country is unknown, give international options and urge "
        "them to call their local emergency number if they are in immediate danger.\n"
