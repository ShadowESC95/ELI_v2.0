...
CATALOG: List[Dict[str, Any]] = [
    {
        ...
        "size_gb": 2.0,
        "vram_gb": 4,
        "note": "Light. Good on 4GB+ GPUs or CPU-only.",
    },
    {
        "key": "qwen2.5-7b",
    ...
    },
    {
        ...
        "url": "https://huggingface.co/bartowski/Qwen2.5-1.5B-Instruct-GGUF/resolve/main/Qwen2.5-1.5B-Instruct-Q5_K_M.gguf",
        "size_gb": 1.3,
        "vram_gb": 0,
        "note": "Smallest. CPU-only friendly; least capable.",
    },
]
