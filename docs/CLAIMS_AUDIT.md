...
Audited at `3025c43` (baseline suite: 8,630 passed). Current suite at **v2.2.6**:
**9,322 passed / 53 skipped / 2 xfailed**, 311 test files.
...
| 9,322+ tests across 311+ files | Verified at v2.2.6: 9,322 passing, 311 files. Stated as a floor, so ordinary growth keeps it true. |
...
build, and ten self-contained unit/claims files. It is **not** the full 9,322-test
