...
Audited at `3025c43` (baseline suite: 8,630 passed). Current suite at **v2.2.5**:
**9,291 passed / 53 skipped / 2 xfailed**, 308 test files.
...
| 9,291+ tests across 308+ files | Verified at v2.2.5: 9,291 passing, 308 files. Stated as a floor, so ordinary growth keeps it true. |
...
build, and ten self-contained unit/claims files. It is **not** the full 9,291-test
