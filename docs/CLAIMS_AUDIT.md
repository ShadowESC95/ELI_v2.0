...
Audited at `3025c43` (baseline suite: 8,630 passed). Current suite at **v2.2.8**:
**9,394 passed / 53 skipped / 2 xfailed**, 313 test files.
...
| 9,394+ tests across 313+ files | Verified at v2.2.8: 9,394 passing, 313 files. Stated as a floor, so ordinary growth keeps it true. |
...
build, and ten self-contained unit/claims files. It is **not** the full 9,394-test
