...
Audited at `3025c43` (baseline suite: 8,630 passed). Current suite at **v2.2.7**:
**9,366 passed / 53 skipped / 2 xfailed**, 312 test files.
...
| 9,366+ tests across 312+ files | Verified at v2.2.7: 9,366 passing, 312 files. Stated as a floor, so ordinary growth keeps it true. |
...
build, and ten self-contained unit/claims files. It is **not** the full 9,366-test
