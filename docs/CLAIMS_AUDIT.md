...
Audited at v2.4.6 (September 2026). Current suite at **v2.4.6**:
**11,815 tests collected**, **11,700+ passed / 54 skipped / 2 xfailed**, 446 test files.
...
| 228 capabilities | `capability_manifest.json` (`total`), enforced by `tests/claims/test_capability_manifest.py` |
| 11,815 tests collected across 446 files | Verified at v2.4.6: 11,711 collected / 11,800+ passing, 446 files. Stated as a floor, so ordinary growth keeps it true. |
