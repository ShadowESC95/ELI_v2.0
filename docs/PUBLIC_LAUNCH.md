...
> **Current release: v2.4.6 (September 2026).** GPU pack auto-install in AppImage/portable;
...
- **Release v2.4.6:** https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.4.6
...
tar -xzf ELI_v2-2.4.6-linux-portable.tar.gz && cd ELI_v2-2.4.6-linux-portable
...
1. Download `ELI-Setup-2.4.6.exe` or `ELI_v2-2.4.6-windows-x64.zip` from the release page
...
1. Download `ELI_v2-2.4.6-macos-arm64.dmg`
...
> **ELI v2.4.6.** Local-first AI assistant (~192k LOC, 227 capabilities, GGUF, PySide6 GUI, offline-by-default). Thread-aware web grounding, honest model identity, phatic fast path. https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.4.6
