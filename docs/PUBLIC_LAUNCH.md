...
> **Current release: v2.3.58 (August 2026).** AgentSpec wizard, Stop generation, honest voice presets, STT/media fixes;
...
- **Release v2.3.55:** https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.3.55
...
tar -xzf ELI_v2-2.3.55-linux-portable.tar.gz && cd ELI_v2-2.3.55-linux-portable
...
1. Download `ELI-Setup-2.3.55.exe` or `ELI_v2-2.3.55-windows-x64.zip` from the release page
...
1. Download `ELI_v2-2.3.55-macos-arm64.dmg`
...
> **ELI v2.3.58.** Local-first AI assistant (~181k LOC, 226 capabilities, GGUF, PySide6 GUI, offline-by-default). AgentSpec agents, Stop button, voice-preset accuracy. https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.3.58
