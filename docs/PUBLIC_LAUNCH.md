...
> **Current release: v2.3.93 (September 2026).** Thread-aware web grounding: conversation topics expand underspecified queries; proactive web on corrections; orchestrator reuses engine intent; consolidated factual gates.
> Builds on v2.3.72 (news deepen + live-session honesty).

## Links (share these)

- **Repo:** https://github.com/ShadowESC95/ELI_v2.0
- **Release v2.3.92:** https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.3.93
...
tar -xzf ELI_v2-2.3.93-linux-portable.tar.gz && cd ELI_v2-2.3.93-linux-portable
...
1. Download `ELI-Setup-2.3.93.exe` or `ELI_v2-2.3.93-windows-x64.zip` from the release page
...
1. Download `ELI_v2-2.3.93-macos-arm64.dmg`
...
> **ELI v2.3.93.** Local-first AI assistant (~190k LOC, 227 capabilities, GGUF, PySide6 GUI, offline-by-default). Thread-aware web grounding, honest model identity, phatic fast path. https://github.com/ShadowESC95/ELI_v2.0/releases/tag/v2.3.93
