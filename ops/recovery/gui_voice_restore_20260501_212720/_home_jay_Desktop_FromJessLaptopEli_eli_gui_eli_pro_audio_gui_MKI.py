...
class EliMainWindow(QMainWindow):
        ...
        def load_worker():
            try:
                if provider == 'ollama':
                    ...
                    _resolved_model_path = getattr(model_manager, 'model_path', None) or model_path or 'model'
                    try:
    ...
    def send_message(self):
        ...
        def generate_worker():
            try:
                try:
                    from eli.brain.cognition.cognitive_engine import get_engine as _get_engine
                except Exception:
                    _get_engine = None
