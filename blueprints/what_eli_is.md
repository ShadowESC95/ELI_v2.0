...
It is not a chatbot bolted onto a cloud API. It is ~195,867 lines of Python in `eli/` that
...
~195,867 lines of Python across 438 files (`eli/`). A real cognitive runtime — not an API
wrapper:
