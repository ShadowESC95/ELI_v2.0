...
It is not a chatbot bolted onto a cloud API. It is ~180,000 lines of Python in `eli/` that
...
~180,000 lines of Python across 421 files (`eli/`). A real cognitive runtime — not an API
wrapper:
