...
It is not a chatbot bolted onto a cloud API. It is ~194,003 lines of Python in `eli/` that
...
~194,003 lines of Python across 434 files (`eli/`). A real cognitive runtime — not an API
wrapper:
