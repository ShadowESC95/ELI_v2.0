...
It is not a chatbot bolted onto a cloud API. It is ~194,623 lines of Python in `eli/` that
...
~194,623 lines of Python across 437 files (`eli/`). A real cognitive runtime — not an API
wrapper:
