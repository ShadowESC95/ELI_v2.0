...
It is not a chatbot bolted onto a cloud API. It is ~193,541 lines of Python in `eli/` that
...
~193,541 lines of Python across 434 files (`eli/`). A real cognitive runtime — not an API
wrapper:
