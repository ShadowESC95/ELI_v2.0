...
> **Updated for v2.3.93.** All CHAT modes run the gradient orchestrator; 15 specialist
...
voice/vision/gaze control, in ~190,338 lines of Python in `eli/`. One machine, your data, no landlord. (The
