...
*Auto-generated 2026-08-03 from `capability_manifest.json` (216 capabilities; 193 routable). Regenerated by `eli/tools/registry/capabilities_doc.py` alongside the manifest.*
...
`ANSWER`, `CHECK_TARGET_STATUS`, `CLOSE_APPLICATION`, `CREATE_DOC`, `CREATE_SCRIPT`, `DIRECT_RESPONSE`, `DOC_GENERATE`, `EXIT_APP`, `EXPLAIN_LAST_FAILURE`, `GENERATE_CODE`, `IMAGE_STATUS`, `LAUNCH_APP`, `OPEN_APPLICATION`, `PLUGIN_STATUS`, `PREPARE_REMEDIATION`, `QUIT_APP`, `SAY`, `SET_AI_MODE`, `STT_DIAGNOSTICS`, `USER_INFO_REPORT`, `WRITE_CODE`, `WRITE_DOCUMENT`, `WRITE_SCRIPT`


## Coverage

- Routable actions documented: **189/193**
- ⚠️ New/undocumented (need a curated phrase): AUTOPILOT_DEBUG, CODEBASE_GRAPH, DESIGN_VOICE, SET_COMMUNICATION_STYLE
