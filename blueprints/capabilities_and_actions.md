...
*Auto-generated 2026-08-28 from `capability_manifest.json` (225 capabilities; 209 routable). Regenerated by `eli/tools/registry/capabilities_doc.py` alongside the manifest.*
...
`ANSWER`, `CHECK_TARGET_STATUS`, `CLOSE_APPLICATION`, `CREATE_DOC`, `CREATE_SCRIPT`, `DIRECT_RESPONSE`, `EXIT_APP`, `GENERATE_CODE`, `LAUNCH_APP`, `OPEN_APPLICATION`, `PREPARE_REMEDIATION`, `QUIT_APP`, `SAY`, `WRITE_CODE`, `WRITE_DOCUMENT`, `WRITE_SCRIPT`


## Coverage

- Routable actions documented: **192/209**
- ⚠️ New/undocumented (need a curated phrase): AUTOPILOT_DEBUG, CODEBASE_GRAPH, DESIGN_VOICE, DOC_GENERATE, IMAGE_STATUS, MCP_ADD, MCP_CALL, MCP_DOCTOR, MCP_LIST, MCP_REMOVE, MCP_STATUS, MCP_TOOLS, PLUGIN_STATUS, SET_AI_MODE, SET_COMMUNICATION_STYLE, STT_DIAGNOSTICS, USER_INFO_REPORT
