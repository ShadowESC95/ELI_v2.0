...
*Auto-generated 2026-09-01 from `capability_manifest.json` (226 capabilities; 209 routable). Regenerated by `eli/tools/registry/capabilities_doc.py` alongside the manifest.*
...
- Routable actions documented: **193/209**
- ⚠️ New/undocumented (need a curated phrase): AUTOPILOT_DEBUG, CODEBASE_GRAPH, DESIGN_VOICE, DOC_GENERATE, IMAGE_STATUS, MCP_ADD, MCP_CALL, MCP_DOCTOR, MCP_LIST, MCP_REMOVE, MCP_STATUS, MCP_TOOLS, PLUGIN_STATUS, SET_AI_MODE, SET_COMMUNICATION_STYLE, USER_INFO_REPORT
