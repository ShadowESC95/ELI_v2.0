...
*Auto-generated 2026-07-27 from `capability_manifest.json` (212 capabilities; 187 routable). Regenerated by `eli/tools/registry/capabilities_doc.py` alongside the manifest.*
...
| `SET_VOICE` | Switch the active TTS voice/accent (distinct from persona tone) | “use the alan voice” · “switch your voice to amy” · “use the HAL voice” | Core |
...
`ANSWER`, `CHECK_TARGET_STATUS`, `CLOSE_APPLICATION`, `CREATE_DOC`, `CREATE_SCRIPT`, `DIRECT_RESPONSE`, `DOC_GENERATE`, `EXIT_APP`, `EXPLAIN_LAST_FAILURE`, `GENERATE_CODE`, `IMAGE_STATUS`, `LAUNCH_APP`, `OPEN_APPLICATION`, `PLUGIN_STATUS`, `PREPARE_REMEDIATION`, `QUIT_APP`, `SAY`, `SEQUENCE_STEP`, `SET_AI_MODE`, `STT_DIAGNOSTICS`, `TEMPLATE`, `USER_INFO_REPORT`, `WRITE_CODE`, `WRITE_DOCUMENT`, `WRITE_SCRIPT`


## Coverage

- Routable actions documented: **186/187**
- ⚠️ New/undocumented (need a curated phrase): SET_COMMUNICATION_STYLE
