...
║                  ~143k LOC · 370 files · desktop GUI + web app server                ║
╚══════════════════════════════════════════════════════════════════════════════════╝
...
└──────┬──────────────────────────────┬───────────────────────────────┬───────────────┘
 ...
 ╚══════╤══════╝            ╚═════════╤══════════╝          ╚═══════════╤═══════════╝
        ...
        ▼                                           ▼
┌─ EXECUTION ───────────────────────────────────────────────────────────────────────┐
│  execution/executor_enhanced.py  ~166 action branches / 208 capabilities (live)    │
...
```
eli/  (~143k LOC, 370 files)  ·  api/server.py  (FastAPI web app + dashboard)
│
...
│   ├── executor_enhanced.py   14.3k   ~174 actions ★god-file
...
│   ├── eli_pro_audio_gui_MKI.py 11.0k ★god-file · app.py · labs_tab.py 5.7k
