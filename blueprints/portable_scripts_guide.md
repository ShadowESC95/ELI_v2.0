...
You have just extracted **`ELI_v2-2.3.55-linux-portable`** and you are looking at a
...
- **Your data lives here** (created automatically on first run):
  ...
  back up the whole `ELI_v2-2.3.55-linux-portable` folder and nothing is lost.
