...
> **Updated for v2.4.71 (September 2026).** The primary way to install ELI is now the
...
You have just extracted **`ELI_v2-2.4.71-linux-portable`** and you are looking at a
...
- **Your data lives here** (created automatically on first run):
  ...
  back up the whole `ELI_v2-2.4.71-linux-portable` folder and nothing is lost.
