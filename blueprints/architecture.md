> **Updated for v2.4.67 (September 2026).** Every CHAT turn runs the gradient
...
> **193,520 lines across 434 Python files in `eli/`**, plus `api/server.py` (2,292 lines).
...
3. **Swallowed errors.** 159 handlers are a bare `except: pass` and 4,347 catch `Exception`,
