...
source). Sizes below are the real v2.3.44 assets.
...
```bash
U=https://github.com/ShadowESC95/ELI_v2.0/releases/download/v2.3.44
wget "$U/ELI_v2-2.3.44-x86_64.AppImage"
...
```bash
./ELI_v2-2.3.44-x86_64.AppImage --integrate      # add/refresh menu entries
./ELI_v2-2.3.44-x86_64.AppImage --uninstall       # remove them
```
