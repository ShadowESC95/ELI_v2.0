...
source). Sizes below are the real v2.3.72 assets.
...
wget "$U/ELI_v2-2.3.72-x86_64.AppImage"
...
```bash
./ELI_v2-2.3.72-x86_64.AppImage --integrate      # add/refresh menu entries
./ELI_v2-2.3.72-x86_64.AppImage --uninstall       # remove them
```
