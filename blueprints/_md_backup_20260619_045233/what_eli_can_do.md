...
memory, and full voice/vision/gaze control — ~140,000 lines of Python, one
...
- **Revised (2026-06-18):** **12 main tabs.** Report Builder is a top-level main tab, but
  **Test & Review + Orchestration were demoted back into Labs** (developer/diagnostic tools),
  so Labs is now **10 sub-tabs**. Background-job listing was unified into the **Tasks** tab
  (removed the Coding tab's duplicate). Files tab gained a Convert-document control (lualatex/pdf/
