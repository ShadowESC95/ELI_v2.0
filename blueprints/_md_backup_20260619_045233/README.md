...
- **Stats:** ~140k LOC / **364** files / **208** capabilities / **166** test files / 14 bus
...
- **Stats (verified, unchanged this session):** ~140k LOC / **364** files / **208** capabilities /
  **14** bus agents / **6,659** tests collected (166 test files).
