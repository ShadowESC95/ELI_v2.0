...
| Module | LOC | Role |
|---|---|---|
| `eli_pro_audio_gui_MKI.py` | 10849 | Main window: 12 tabs + adapters (CentralMemory/LocalModel/Ollama/Executor bridges, the `_GUIEngineAdapter`), chat, drag-drop, reasoning-mode auto-select, all toggles. |
...
- **GUI:** **12 main tabs** (Report Builder promoted to top-level; Test & Review + Orchestration
  are Labs sub-tabs); Files-tab converter.
