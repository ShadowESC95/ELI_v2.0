...
- **Code:** ~140k LOC, 364 `.py` under `eli/` (12 main GUI tabs; 14 bus agents +
  CodeAgent; 4 SQLite stores; 208 manifest capabilities / 174 SUPPORTED_ACTIONS).
- **Tests:** ~6,900 (6,924 collected; 6,880 passed). 0 failed, 2 xfail (documented
  routing gaps), 42 skipped.
