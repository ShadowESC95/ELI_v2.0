...
| Test files | — | **166** |
| Capabilities (manifest, measured by `capability_sync`) | "~143 actions" | **208** (183 routable: ~170 executor/router + 13 plugin) — **~110 distinct** after alias families |
| Bus agents | "15" | **14** |
...
- **Counts now:** **133,430 LOC / 351 files / 208 capabilities (167 SUPPORTED_ACTIONS) /
  166 test files / 12 main GUI tabs.** Suite: **6,586 passed / 0 failed / 2 xfailed / 42
