...
Current semver: **`pyproject.toml`** → **2.4.49** (tag **`v2.4.49`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.49` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.49 && git push origin v2.4.49
```
