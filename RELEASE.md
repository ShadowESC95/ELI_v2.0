...
Current semver: **`pyproject.toml`** → **2.4.54** (tag **`v2.4.54`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.54` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.54 && git push origin v2.4.54
```
