...
Current semver: **`pyproject.toml`** → **2.4.34** (tag **`v2.4.34`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.34` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.34 && git push origin v2.4.34
```
