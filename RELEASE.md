...
Current semver: **`pyproject.toml`** → **2.4.69** (tag **`v2.4.69`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.69` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.69 && git push origin v2.4.69
```
