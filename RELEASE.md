...
Current semver: **`pyproject.toml`** → **2.4.48** (tag **`v2.4.48`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.48` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.48 && git push origin v2.4.48
```
