...
Current semver: **`pyproject.toml`** → **2.4.72** (tag **`v2.4.72`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.72` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.72 && git push origin v2.4.72
```
