...
Current semver: **`pyproject.toml`** → **2.4.53** (tag **`v2.4.53`**).

## 1. Build packages

**CI / tag push (recommended):** push tag `v2.4.53` — workflow builds AppImage, portable, Windows, macOS.
...
```bash
git tag v2.4.53 && git push origin v2.4.53
```
