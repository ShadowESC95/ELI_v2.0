...
| `test_license_reachable.py` | the PolyForm Noncommercial licence is reachable from every download — docs present, ELI.spec ships them, dmg/AppImage stage them, Inno shows a licence pane, `--license` works on both entry points | 13 |
