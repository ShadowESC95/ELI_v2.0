...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Per-device hub — picker chips + detail panel */
  .devhub { margin-bottom:18px; }
  .devpick { display:flex; gap:8px; overflow-x:auto; padding:4px 2px 10px; scrollbar-width:none; }
  .devpick::-webkit-scrollbar { display:none; }
  .devchip { flex:none; padding:8px 14px; border-radius:12px; border:1px solid var(--line); background:rgba(6,11,20,.55); color:var(--fg-dim); font-size:13px; cursor:pointer; transition:var(--fast); }
  .devchip:hover { border-color:rgba(34,211,238,.35); color:var(--fg); }
  .devchip.active { border-color:rgba(34,211,238,.55); background:rgba(34,211,238,.1); color:var(--accent); box-shadow:0 0 14px rgba(34,211,238,.18); }
  .devhub-body { border:1px solid var(--line); border-radius:16px; padding:14px; background:linear-gradient(158deg,rgba(18,28,46,.55),rgba(8,12,22,.5)); }
  .devhub-body .subtabs { margin-bottom:12px; }
  .devhub-hd { display:flex; align-items:center; gap:12px; margin-bottom:12px; }
  .devhub-hd .dicon { width:44px; height:44px; font-size:20px; }
  .devhub-hd .nm { font-size:16px; font-weight:600; }
  .devhub-hd .dom { font-size:12px; color:var(--mut); }
  .devact { display:flex; flex-wrap:wrap; gap:8px; margin-top:10px; }
  .devurl { display:flex; gap:8px; margin-top:10px; flex-wrap:wrap; }
  .devurl input { flex:1; min-width:180px; padding:8px 10px; border:1px solid var(--line); border-radius:8px; background:var(--input); color:var(--fg); font-size:13px; }
  .card.devsel { outline:2px solid rgba(34,211,238,.45); box-shadow:0 0 20px rgba(34,211,238,.2); }
  .card.hubopen { cursor:pointer; }
